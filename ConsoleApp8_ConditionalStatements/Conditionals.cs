...
namespace CSharp1Exercises.ControlFlow
{
    public class Conditionals
    {
        ...
        {
            //Console.WriteLine(ImageOrientation.Landscape); //here we read the "name" of enum
            //Console.WriteLine((int)ImageOrientation.Landscape); //here we read the "value" numerical of enum
            //Console.WriteLine(ImageOrientation.Portrait);
            //Console.WriteLine((int)ImageOrientation.Portrait);
        ...
        public enum ImageOrientation //here is the declaration of the enum
        {
            Landscape, //since we did not declare a type, will be int
                       //since we did not specify a value, will start from 0
            Portrait   //same as above, just 0 is incremented by 1, so value is 1 here
        }
